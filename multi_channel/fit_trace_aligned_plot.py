...
plot_traces30(sim_fit_30_traces, [(0, 0, 0), 'grey'], ['WT_fit', 'WT_exp'], 'WT')
plot_traces30(sim_fit_30_traces, [(0, 0, 0), 'grey'], ['WT_LC_fit', 'WT_LC_exp'], 'WT_LC')

plot_traces30(sim_fit_30_traces, [(0.88, 0.54, 0.31), 'grey'], ['G258V_fit', 'G258V_exp'], 'G258V')
plot_traces30(sim_fit_30_traces, [(0.8, 0.74, 0.43), 'grey'], ['L296V_fit', 'L296V_exp'], 'L296V')
plot_traces30(sim_fit_30_traces, [(0.77, 0.20, 0.25), 'grey'], ['G254V_fit', 'G254V_exp'], 'G254V')

plot_traces1000(sim_fit_1000_traces, [(0, 0, 0), 'grey'], ['WT_fit', 'WT_exp'], 'WT_1000')
plot_traces1000(sim_fit_1000_traces, [(0.60, 0.75, 0.75), 'grey'], ['L300V_fit', 'L300V_exp'], 'L300V')
