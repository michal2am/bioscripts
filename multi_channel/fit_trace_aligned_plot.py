...
def plot_traces(sim_fit_30_traces, sim_fit_colors, simt_fit_types, file):
...
plot_traces(sim_fit_30_traces, [(0, 0, 0), (0, 0, 0)], ['WT_exp', 'WT_fit'], 'WT')
plot_traces(sim_fit_30_traces, [(0, 0, 0), (0, 0, 0)], ['WT_LC_exp', 'WT_LC_fit'], 'WT_LC')

plot_traces(sim_fit_30_traces, [(0.88, 0.54, 0.31), (0.88, 0.54, 0.31)], ['G258V_exp', 'G258V_fit'], 'G258V')
plot_traces(sim_fit_30_traces, [(0.8, 0.74, 0.43), (0.8, 0.74, 0.43)], ['L296V_exp', 'L296V_fit'], 'L296V')
plot_traces(sim_fit_30_traces, [(0.77, 0.20, 0.25), (0.77, 0.20, 0.25)], ['G254V_exp', 'G254V_fit'], 'G254V')
