...
gmx mdrun -v -deffnm ${mini_prefix} -pin on -pinstride 1 -nt 8 -pinoffset 24 -gpu_id 1
...
do
        ...
        gmx mdrun -v -deffnm ${istep} -nb gpu -pme gpu -update gpu -bonded gpu -pin on -pinstride 1 -ntmpi 1 -ntomp 8 -gpu_id 1 -pinoffset 24
