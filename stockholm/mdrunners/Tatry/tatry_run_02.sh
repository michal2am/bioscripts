...
gmx mdrun -v -deffnm step7_production -cpi -pmefft gpu -nb gpu -pme gpu -update gpu -bonded gpu -pin on -pinstride 1 -ntmpi 1 -ntomp 8 -gpu_id 0 -pinoffset 8 -maxh 96
