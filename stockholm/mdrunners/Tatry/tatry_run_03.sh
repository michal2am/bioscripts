...
gmx mdrun -v -deffnm step7_production -cpi -nb gpu -pmefft gpu -pme gpu -update gpu -bonded gpu -pin on -pinstride 1 -ntmpi 1 -ntomp 8 -gpu_id 1 -pinoffset 16 -maxh 96
